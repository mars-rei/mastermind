...
def test_end_single_player_game(capsys):
    end_game(False, (CodeBreaker(), CPU()), (Code_Peg_Option.Orange, Code_Peg_Option.Green, Code_Peg_Option.Blue, Code_Peg_Option.Purple))
...
def test_end_multiplayer_game(capsys):
    end_game(False, (CodeBreaker(), CodeMaker()), (Code_Peg_Option.Orange, Code_Peg_Option.Green, Code_Peg_Option.Blue, Code_Peg_Option.Purple))
    capture = capsys.readouterr()
...
def test_end_campaign_game(capsys):
    end_game(True, (CodeBreaker(), CPU()), (Code_Peg_Option.Orange, Code_Peg_Option.Green, Code_Peg_Option.Blue, Code_Peg_Option.Purple))
    capture = capsys.readouterr()
